...
const BATTLE_URL = import.meta.env.VITE_API_BASE_URL ? import.meta.env.VITE_API_BASE_URL.replace('/api', '') : 'http://localhost:3000';
...
const useSocketStore = create((set, get) => ({
  ...
  connect: (userId, username) => {
    ...
    newSocket.on('connect', () => {
      ...
      newSocket.emit('user:identify', { userId, username });
    });
